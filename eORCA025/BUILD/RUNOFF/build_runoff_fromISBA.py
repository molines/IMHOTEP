...
INDIR='/ccc/work/cont005/gen1140/jouannoj/FORCING/TATL025BIO-I/'
OUTDIR='/ccc/work/cont005/gen1140/jouannoj/FORCING/TATL025BIO-I/runoff_ISBA/'
RIVDIR='/ccc/work/cont005/legos/legos/DATA_OBS/DEBITS/'

### Read river runoff ISNA ISBA
filein=RIVDIR+'sfxcm6_05d_erai_gpcc_daily_qdis_mouth_1979-2017_congohybam.nc'
ncisba = netcdf(filein,'r');
param_discharge='qdis'
...
for year in range(1979,2018):
     ...
     for j in range(nj_isba):
       ...
       #
           ...
           for nb_point in range(npoints): ## on cherche ici 1 point
                 ...
                 #Garder les points a une distance max de 0.75deglon/lat 
  ...
  # Ecriture fichier
  fileout=OUTDIR+'TATL025_runoffISBA_'+str(year)+'.nc'
  ...
  netcdf_socoefr0=ncfileout.createVariable('socoefr0','f',('y','x'))
